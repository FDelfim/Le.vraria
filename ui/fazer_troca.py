...
# Form implementation generated from reading ui file '.\fazer troca.ui'
#
...
"}")
        ...
        self.lineEdit_3.setGeometry(QtCore.QRect(20, 180, 651, 45))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_title.setText(_translate("MainWindow", "FAZER TROCA - PONTOS POR LIVRO"))
        self.lineEdit_1.setPlaceholderText(_translate("MainWindow", "ID LIVRO"))
        self.lineEdit_2.setPlaceholderText(_translate("MainWindow", "CPF CLIENTE"))
        self.lineEdit_3.setPlaceholderText(_translate("MainWindow", "CPF FUNCIONÁRIO"))
